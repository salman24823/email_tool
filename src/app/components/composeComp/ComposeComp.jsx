...
import { Button, Card, Input, Textarea, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, useDisclosure } from '@heroui/react';
                ...
                <Card className="mt-6 border-slate-200">
                    <div className="p-6">
                        ...
                        <p className="text-sm font-medium text-slate-700">
                            Emails Sent: {sentCount} {totalEmails > 0 ? `/ ${totalEmails}` : ''}
                        </p>
                        {totalEmails > 0 && (
                            <div className="mt-4">
                            ...
                            <ModalBody>
                                <div className="space-y-2 max-h-96 overflow-y-auto">
                                    ...
                                    {logMessages.map((log, index) => (
                                        <p
                                            key={index}
                                            className={`text-sm ${log.type === 'success' ? 'text-green-600' :
